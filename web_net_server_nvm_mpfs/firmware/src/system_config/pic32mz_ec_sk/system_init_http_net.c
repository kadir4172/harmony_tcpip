...
const TCPIP_HTTP_MODULE_CONFIG tcpipHTTPInitData =
{
    ...
    .sktTxBuffSize	= 2048, //TCPIP_HTTP_SKT_TX_BUFF_SIZE,
    .sktRxBuffSize	= 2048, //TCPIP_HTTP_SKT_RX_BUFF_SIZE,
    .tlsSktTxBuffSize	= TCPIP_HTTP_TLS_SKT_TX_BUFF_SIZE,
    .tlsSktRxBuffSize	= TCPIP_HTTP_TLS_SKT_RX_BUFF_SIZE,
    .configFlags	= 0, // TCPIP_HTTP_CONFIG_FLAGS,
};
/*** HTTP NET Server Initialization Data ***/
const TCPIP_HTTP_NET_MODULE_CONFIG tcpipHTTPNetInitData =
{
    ...
    .sktTxBuffSize	= 2048, //TCPIP_HTTP_NET_SKT_TX_BUFF_SIZE,
    .sktRxBuffSize	= 2048, //TCPIP_HTTP_NET_SKT_RX_BUFF_SIZE,
...
const  TCPIP_DHCPV6_MODULE_CONFIG tcpipDHCPv6InitData = 
{
    .configFlags = 0,
    .dhcpCliPort = TCPIP_DHCPV6_CLIENT_PORT,
    .dhcpSrvPort = TCPIP_DHCPV6_SERVER_PORT,
    .duidType = TCPIP_DHCPV6_CLIENT_DUID_TYPE,
...
const TCPIP_STACK_MODULE_CONFIG TCPIP_STACK_MODULE_CONFIG_TBL [] =
{
    ...
    //{TCPIP_MODULE_DHCPV6_CLIENT,   &tcpipDHCPv6InitData},                        // TCPIP_MODULE_DHCPV6_CLIENT,
    // MAC modules
