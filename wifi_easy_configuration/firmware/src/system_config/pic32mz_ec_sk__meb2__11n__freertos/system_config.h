...
#define SYS_PORT_F_ANSEL        0x2000
...
#define SYS_PORT_G_ANSEL        0x8340
...
#define WDRV_EXT_RTOS_INIT_TASK_PRIORITY 2u
...
// I/O mappings for general control pins, including CS, POWER, RESET and INTERRUPT.
#define WF_CS_PORT_CHANNEL PORT_CHANNEL_E
#define WF_CS_BIT_POS      9

#define WF_POWER_PORT_CHANNEL PORT_CHANNEL_B
